...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ezcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ezcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ezcoin transaction") + "\n" +
              "  ezcoin-tx [options] -create [commands]   " + _("Create hex-encoded ezcoin transaction") + "\n" +
              "\n";
